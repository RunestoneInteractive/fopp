$.i18n().load({
    "en": {
        ...
        "msg_activecode_time_limit_error_fix": "Add some print statements to figure out if your program is in an infinite loop.  If it is not you can increase the run time with `import sys; sys.setExecutionLimit(msecs)` where msecs is the maximum number of milliseconds.",
