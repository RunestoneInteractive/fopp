...
The lists we have seen so far have had numbers or strings as items. Perhaps you noticed the lists of tuples that are 
returned by the ``.items()`` method of dictionaries.
...
Lines 1-4 above probably look pretty natural to you. Line 6 is just a reminder that you index into a list that is written 
out just as you can index into a list referred to by a variable.
...
list ['d', 'e'], nested[1][0] is the same as ['d', 'e'][0]. So line 7 is equivalent to lines 2 and 4; it is a simpler way
...
sure what the structure is of your data, and so you need to incrementally write and debug your code. Often, you will 
